...
export const AmountDetailsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-6 pt-9 pb-0 px-6 w-full">
        ...
        <div className="flex flex-col items-start gap-[22px] w-full">
                ...
                <div className="flex flex-col items-start gap-0.5 w-full">
                  ...
                  {detail.subValue && (
                    <div className="flex items-center gap-1 w-full">
                      <div
                        className={`flex-1 mt-[-1.00px] font-body-14-r font-[number:var(--body-14-r-font-weight)] text-[length:var(--body-14-r-font-size)] text-right tracking-[var(--body-14-r-letter-spacing)] leading-[var(--body-14-r-line-height)] [font-style:var(--body-14-r-font-style)] ${index === 1 ? "text-[#5e616b]" : "text-[#1c253f]"}`}
                      >
                        {detail.subValue}
                      </div>
                    </div>
          ...
          <div className="flex flex-col items-start gap-4 px-5 py-[22px] w-full bg-[#f4f7fd] rounded-xl">
            ...
            <img
              ...
              alt="Line"
              src="https://c.animaapp.com/yNx7OGE7/img/line-407-5.svg"
            />
      ...
      <button className="inline-flex items-center gap-2 cursor-pointer bg-transparent border-0 p-0">
        <img
        ...
        <div className="inline-flex items-center gap-0.5">
          <div className="w-fit font-body-15-r font-[number:var(--body-15-r-font-weight)] text-[#717682] text-[length:var(--body-15-r-font-size)] text-center tracking-[var(--body-15-r-letter-spacing)] leading-[var(--body-15-r-line-height)] underline whitespace-nowrap mt-[-1.00px] [font-style:var(--body-15-r-font-style)]">
            [머니그램] 픽업장소를 확인해주세요.
          </div>
          <img
      ...
      <Button
        variant="outline"
        className="inline-flex h-auto min-h-[46px] items-center justify-center gap-2.5 pl-[26px] pr-5 py-1 bg-white rounded-[30px] border border-solid border-neutral-800"
      >
        <div className="inline-flex items-center justify-center gap-2">
          <div className="inline-flex items-center gap-1">
            <div className="flex items-center justify-center font-title-15-SB font-[number:var(--title-15-SB-font-weight)] text-neutral-800 text-[length:var(--title-15-SB-font-size)] text-center tracking-[var(--title-15-SB-letter-spacing)] leading-[var(--title-15-SB-line-height)] w-fit mt-[-1.00px] whitespace-nowrap [font-style:var(--title-15-SB-font-style)]">
              송금 취소
            </div>
