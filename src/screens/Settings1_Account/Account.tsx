...
export const Account = (): JSX.Element => {
  return (
    <div
      className="flex flex-col h-screen items-start bg-[linear-gradient(0deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0.75)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)]"
      data-model-id="36848:78590"
    >
      <PopupHeader />

      <main className="flex flex-col items-center flex-1 self-stretch w-full">
          <section className="items-center gap-[41px] pt-3.5 pb-0 px-0 self-stretch w-full flex-[0_0_auto] flex flex-col relative">
            <div className="items-start gap-[7px] px-6 py-0 self-stretch w-full flex-[0_0_auto] flex flex-col relative">
          ...
          <section className="flex items-center justify-center gap-2.5 pb-0 px-0 relative flex-1 self-stretch w-full">
            <div className="relative w-[260px] h-[290px] bg-white rounded-[160px]" />
          </section>

          <section className="h-[150px] items-center justify-between pt-0 pb-[30px] px-0 self-stretch w-full flex flex-col relative">
            ...
            <div className="relative w-[72px] h-[70px]">
              ...
              <img
                ...
                alt="Ellipse"
                src="https://c.animaapp.com/w2kCT5wM/img/ellipse-4638.svg"
              />
            </div>
          </section>
        </main>
