  ...
  const statusBarIcons = [
    {
      ...
      src: "/img/bar-1-4.png",
      className:
        "h-[40.00%] top-[-102560.00%] left-[-69516.67%] absolute w-[16.67%]",
    },
    {
      alt: "Bar",
      src: "/img/bar-2-5.png",
      className:
        "h-[60.00%] top-[-102580.00%] left-[-69488.89%] absolute w-[16.67%]",
    },
    {
      alt: "Bar",
      src: "/img/bar-3-5.png",
      className:
        "h-[80.00%] top-[-102600%] left-[-69461.11%] absolute w-[16.67%]",
    },
    {
      alt: "Bar",
      src: "/img/bar-4-3.png",
      className:
        "h-full top-[-102620.00%] left-[-69433.33%] absolute w-[16.67%]",
    },
  ];
  ...
  const wifiIcons = [
    {
      ...
      src: "/img/bar-1-5.png",
      className:
        "absolute w-[31.30%] h-[30.17%] top-[-88244.04%] left-[-78321.93%]",
    },
    {
      alt: "Bar",
      src: "/img/bar-2-6.png",
      className:
        "absolute w-[62.57%] h-[34.44%] top-[-88280.15%] left-[-78337.50%]",
    },
    {
      alt: "Bar",
      src: "/img/bar-3-6.png",
      className:
        "absolute w-[100.01%] h-[43.03%] top-[-88313.87%] left-[-78356.27%]",
    },
  ];
            ...
            <div className="flex h-6 items-center justify-between px-2.5 py-1 relative self-stretch w-full bg-white">
              ...
              <div className="inline-flex items-center gap-1.5 relative flex-[0_0_auto] mt-[-0.50px] mb-[-0.50px]">
                ...
                <div className="relative w-6 h-3 overflow-hidden">
                  <img
                    className="absolute w-[87.51%] h-full top-[-85508.33%] left-[-52504.17%]"
                    alt="Border"
                  ...
                  <img
                    className="absolute w-[8.33%] h-[33.33%] top-[-85475.00%] left-[-52412.50%]"
                    alt="Cap"
                    src="/img/cap-3.png"
                  />
                </div>
          ...
          <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
            <div className="flex h-[54px] items-center justify-around px-5 py-0 relative self-stretch w-full bg-white">
              ...
              <img
                ...
                alt="Mini"
                src="https://c.animaapp.com/dojq12ez/img/mini-4@2x.png"
              />
            </div>
          </div>
        </nav>

        <main className="flex flex-col items-start gap-2.5 pt-0 pb-14 px-6 relative flex-1 self-stretch w-full grow">
