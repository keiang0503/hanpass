...
export const FrameSubsection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-start gap-2.5 pt-8 pb-0 px-6 w-full">
      <Card className="w-full bg-[#f4f7fd] border-0 rounded-2xl overflow-hidden cursor-pointer hover:bg-[#e8ecf5] transition-colors">
        <CardContent className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center justify-center flex-shrink-0 ml-4">
            <img
              src="https://c.animaapp.com/emBHvnWi/img/free-icon-consulting-services-14274100-1-3@2x.png"
