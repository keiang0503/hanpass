        ...
        <Card className="w-full bg-white rounded-2xl border border-solid border-[#e6eaec]">
          <CardContent className="flex flex-col items-center justify-center gap-4 p-4">
            <div className="flex flex-col items-start gap-4 w-full">
              ...
              <div className="relative w-full h-2 bg-[#dfe3ec] rounded-[999px] overflow-hidden">
                <div className="absolute w-[152px] h-2 bg-[#45a6ff] rounded-[999px]" />
              </div>
            </div>
              ...
              <div className="flex flex-col items-start gap-3 p-4 w-full bg-[#f7f7f8] rounded-lg">
                {limitDetails.map((detail, index) => (
                  <div key={index} className="flex items-center gap-1 w-full">
                    ...
                    <div
                      className={`flex-1 mt-[-1.00px] font-caption-title-13-r font-[number:var(--caption-title-13-r-font-weight)] ${detail.textColor} text-[length:var(--caption-title-13-r-font-size)] text-right tracking-[var(--caption-title-13-r-letter-spacing)] leading-[var(--caption-title-13-r-line-height)] [font-style:var(--caption-title-13-r-font-style)]`}
                    >
                      {detail.value}
                    </div>
                  </div>
