...
export const MyContainerWrapperSubsection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-start gap-2 px-5 py-0 w-full">
      <Card className="w-full border-[#e6eaec] shadow-[0px_4px_8px_#00000014]">
        <CardContent className="flex flex-col items-center gap-4 p-4">
          <header className="flex h-[52px] items-center gap-3 w-full">
            <div className="relative w-[30px] h-[30px] bg-[url(https://c.animaapp.com/emBHvnWi/img/country.svg)] bg-[100%_100%] flex-shrink-0" />
