...
const bankDetails = [
  {
    label: "출금은행",
    value: "우리은행",
    subValues: ["1002843678105"],
  },
  {
    label: "입금 은행",
    value: "전북은행",
    subValues: ["Jeonbuk Bank", "1002843678105"],
  },
  {
    label: "예금주명",
    value: "민세정",
...
const depositInfo = [
  {
    label: "입금 만료일",
    value: "2025.11.03 13:29:35 KST",
  },
];

export const AmountDetailsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-6 pt-9 pb-0 px-6 w-full">
            ...
            {bankDetails.map((detail, index) => (
              ...
              >
                <div className="flex flex-col items-start gap-0.5 w-full">
                  ...
                  {detail.subValues.map((subValue, subIndex) => (
                    <div
                      key={subIndex}
                      className="flex items-center gap-1 w-full"
                    >
                      <div
                        className={`flex-1 mt-[-1.00px] font-body-14-r font-[number:var(--body-14-r-font-weight)] text-right tracking-[var(--body-14-r-letter-spacing)] leading-[var(--body-14-r-line-height)] [font-style:var(--body-14-r-font-style)] ${
                          subIndex === 0 && detail.subValues.length > 1
                            ? "text-[#5e616b]"
                            : "text-[#1c253f]"
                        }`}
                        style={{
                          fontSize: "var(--body-14-r-font-size)",
                        }}
                      >
                        {subValue}
                      </div>
      ...
      <a href="#" className="inline-flex items-center gap-2">
        ...
        <div className="inline-flex items-center gap-0.5">
          <span className="w-fit font-body-15-r font-[number:var(--body-15-r-font-weight)] text-[#717682] text-[length:var(--body-15-r-font-size)] text-center tracking-[var(--body-15-r-letter-spacing)] leading-[var(--body-15-r-line-height)] underline whitespace-nowrap mt-[-1.00px] [font-style:var(--body-15-r-font-style)]">
            [머니그램] 픽업장소를 확인해주세요.
          </span>
          ...
          <img
            ...
            alt="Btn arrow"
            src="https://c.animaapp.com/yNx7OGE7/img/ico20-btn-arrow-right-blue-5.svg"
          />
        </div>
      </a>

      <div className="inline-flex justify-center gap-2.5 items-start">
        <Button
          variant="outline"
          className="h-auto min-h-[46px] inline-flex flex-col items-center justify-center gap-2.5 px-[26px] py-1 bg-white rounded-[30px] border border-solid border-[#fe397e] hover:bg-white"
        >
          <div className="flex items-center justify-center gap-2 w-full">
            <div className="flex w-20 items-center gap-1">
              <span className="flex items-center justify-center flex-1 font-title-15-SB font-[number:var(--title-15-SB-font-weight)] text-[#fe397e] text-[length:var(--title-15-SB-font-size)] text-center tracking-[var(--title-15-SB-letter-spacing)] leading-[var(--title-15-SB-line-height)] mt-[-1.00px] [font-style:var(--title-15-SB-font-style)]">
                송금 거절
              </span>

              <ChevronRightIcon className="w-4 h-4 text-[#fe397e]" />
            </div>
          </div>
        </Button>
      </div>
