          ...
          <section className="flex flex-col items-start gap-3.5 pt-42 pb-14 px-6 w-full">
            <div className="flex flex-col items-start gap-30 w-full">
              ...
              <div className="flex flex-col items-center gap-4 w-full">
                <Button className="min-h-54 w-full bg-[#0d56e4] hover:bg-[rgba(13,86,228,0.9)] rounded-xl h-auto px-26 py-1.5 font-title-16-b font-[number:var(--title-16-b-font-weight)] text-white text-[length:var(--title-16-b-font-size)] tracking-[var(--title-16-b-letter-spacing)] leading-[var(--title-16-b-line-height)] [font-style:var(--title-16-b-font-style)]">
                  로그인
                </Button>
          ...
          <section className="flex flex-col justify-end px-6 py-0 w-full">
            <div className="flex flex-col items-center gap-4 w-full">
              <div className="flex flex-col items-start gap-2 w-full">
                <Button
                  variant="outline"
                  className="min-h-54 w-full border-light-blue hover:bg-white rounded-xl h-auto px-2 py-1 font-title-16-b font-[number:var(--title-16-b-font-weight)] text-primary text-[length:var(--title-16-b-font-size)] tracking-[var(--title-16-b-letter-spacing)] leading-[var(--title-16-b-line-height)] [font-style:var(--title-16-b-font-style)]"
                >
                  회원가입
                </Button>
