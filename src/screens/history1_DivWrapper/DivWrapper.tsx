            ...
            <div className="flex h-6 items-center justify-between px-2.5 py-1 relative self-stretch w-full bg-white">
              ...
              <div className="inline-flex items-center gap-1.5 relative flex-[0_0_auto] mt-[-0.50px] mb-[-0.50px]">
                <div className="relative w-[18px] h-2.5">
                  <img
                    className="h-[40.00%] top-[-39550.00%] left-[-17155.56%] absolute w-[16.67%]"
                    alt="Bar"
                    src="/img/bar-1-12.png"
                  />

                  <img
                    className="h-[60.00%] top-[-39570.00%] left-[-17127.78%] absolute w-[16.67%]"
                    alt="Bar"
                    src="/img/bar-2-13.png"
                  />

                  <img
                    className="h-[80.00%] top-[-39590.00%] left-[-17100%] absolute w-[16.67%]"
                    alt="Bar"
                    src="/img/bar-3-13.png"
                  />

                  <img
                    className="h-full top-[-39610.00%] left-[-17072.22%] absolute w-[16.67%]"
                    alt="Bar"
                    src="/img/bar-4-7.png"
                  />
                </div>
                ...
                <div className="relative w-4 h-[11.62px] overflow-hidden">
                  <img
                    className="absolute w-[31.30%] h-[30.17%] top-[-34013.91%] left-[-19415.68%]"
                    alt="Bar"
                    src="/img/bar-1-13.png"
                  />

                  <img
                    className="absolute w-[62.57%] h-[34.44%] top-[-34050.01%] left-[-19431.25%]"
                    alt="Bar"
                    src="/img/bar-2-14.png"
                  />

                  <img
                    className="absolute w-[100.01%] h-[43.03%] top-[-34083.73%] left-[-19450.02%]"
                    alt="Bar"
                ...
                <div className="relative w-6 h-3 overflow-hidden">
                  <img
                    className="absolute w-[87.51%] h-full top-[-33000%] left-[-13233.34%]"
                    alt="Border"
                  ...
                  <img
                    className="absolute w-[8.33%] h-[33.33%] top-[-32966.67%] left-[-13141.67%]"
                    alt="Cap"
                    src="/img/cap-7.png"
                  />
                </div>
