...
export const VerificationCode = (): JSX.Element => {
  return (
    <div className="flex flex-col w-full min-h-screen bg-white" data-model-id="40000001:45837">
      {/* Navigation Header */}
      ...
      {/* Keypad Section */}
      <section className="flex flex-col flex-1 justify-end gap-2.5 w-full">
