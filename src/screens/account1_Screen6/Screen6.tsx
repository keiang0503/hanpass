                  ...
                  <div className="items-center gap-1.5 px-5 py-0 self-stretch w-full flex-[0_0_auto] flex relative">
                    <div className="items-center justify-between flex-1 grow flex relative">
                      <div className="flex-wrap items-center gap-[8px_8px] flex-1 grow flex relative">
                        <Badge
                          variant="outline"
                          className="inline-flex justify-center gap-2.5 px-2.5 py-1 flex-[0_0_auto] bg-white rounded-[50px] border border-solid border-[#dfe3ec] rotate-180 items-center h-auto"
                        >
                          <span className="relative w-fit mt-[-1.00px] -rotate-180 font-navigation-12-b font-[number:var(--navigation-12-b-font-weight)] text-[#003fbb] text-[length:var(--navigation-12-b-font-size)] tracking-[var(--navigation-12-b-letter-spacing)] leading-[var(--navigation-12-b-line-height)] whitespace-nowrap [font-style:var(--navigation-12-b-font-style)]">
                            Auto
                          </span>
                        </Badge>

                        <Badge className="inline-flex items-center justify-center gap-2.5 px-2.5 py-1 relative flex-[0_0_auto] bg-[#e9f1ff] rounded-[50px] rotate-180 h-auto hover:bg-[#e9f1ff]">
                          <span className="relative w-fit mt-[-1.00px] -rotate-180 font-navigation-12-SB font-[number:var(--navigation-12-SB-font-weight)] text-[#003fbb] text-[length:var(--navigation-12-SB-font-size)] tracking-[var(--navigation-12-SB-letter-spacing)] leading-[var(--navigation-12-SB-line-height)] whitespace-nowrap [font-style:var(--navigation-12-SB-font-style)]">
                            주계좌
                          </span>
                        </Badge>
                      </div>
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        className="relative w-5 h-5 p-0 h-auto"
                      >
