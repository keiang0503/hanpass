...
export const AmountInfoSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-6 pt-9 pb-0 px-6 w-full">
                      ...
                      <div
                        className={`flex-1 mt-[-1.00px] font-body-14-r font-[number:var(--body-14-r-font-weight)] text-right tracking-[var(--body-14-r-letter-spacing)] leading-[var(--body-14-r-line-height)] [font-style:var(--body-14-r-font-style)] ${
                          subIndex === 0 && index === 1
                            ? "text-[#5e616b]"
                            : "text-[#1c253f]"
                        } text-[length:var(--body-14-r-font-size)]`}
                      >
                        {subValue}
                      </div>
                    </div>
      ...
      <Button
        variant="link"
        className="inline-flex items-center gap-2 h-auto p-0"
      >
        <img
      ...
      <Button
        variant="outline"
        className="inline-flex min-h-[46px] items-center justify-center gap-2.5 pl-[26px] pr-5 py-1 h-auto bg-white rounded-[30px] border border-solid border-[#0b51b9] hover:bg-white"
      >
        <div className="inline-flex items-center justify-center gap-2">
          <div className="inline-flex items-center gap-1">
            <span className="flex items-center justify-center font-title-15-SB font-[number:var(--title-15-SB-font-weight)] text-[#0b51b9] text-[length:var(--title-15-SB-font-size)] text-center tracking-[var(--title-15-SB-letter-spacing)] leading-[var(--title-15-SB-line-height)] w-fit mt-[-1.00px] whitespace-nowrap [font-style:var(--title-15-SB-font-style)]">
              송금 완료
            </span>
            <img
              className="w-4 h-4"
              alt="Btn arrow"
              src="https://c.animaapp.com/yNx7OGE7/img/ico16-btn-arrow-right-3.svg"
            />
          </div>
        </div>
      </Button>
