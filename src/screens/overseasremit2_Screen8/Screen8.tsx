          ...
          <CardContent className="flex flex-col items-start gap-4 px-5 py-[22px]">
            <div className="flex flex-col items-start gap-2.5 w-full">
              <div className="flex items-center justify-between w-full">
                <span className="text-[#85888e] text-sm">보내는 금액</span>
                <span className="text-[#1c253f] text-sm font-semibold">987,393 KRW</span>
              </div>

              <div className="flex items-center justify-between w-full">
                <span className="text-[#85888e] text-sm">받는 금액</span>
                <span className="text-[#1c253f] text-sm font-semibold">1000,000 NPR</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between w-full">
              <span className="text-[#85888e] text-sm">입금액</span>
              <div className="flex flex-col items-end gap-1">
                <span className="text-[#0d56e4] text-base font-bold">992,393 KRW</span>
                <span className="text-[#85888e] text-xs">입금 수수료: 5,000 KRW</span>
              </div>
            </div>
          </CardContent>
        </Card>
