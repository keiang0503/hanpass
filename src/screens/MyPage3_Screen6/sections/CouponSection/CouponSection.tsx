...
export const CouponSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-start px-6 py-0 bg-white w-full">
      <div className="flex flex-col items-start gap-2 pt-[22px] pb-0 px-0 w-full">
        <div className="flex flex-col items-start w-full">
          <h2 className="w-full mt-[-1.00px] font-title-24-b font-[number:var(--title-24-b-font-weight)] text-[#0b0c0e] text-[length:var(--title-24-b-font-size)] tracking-[var(--title-24-b-letter-spacing)] leading-[var(--title-24-b-line-height)] [font-style:var(--title-24-b-font-style)]">
            내 친구를
            <br />
            초대해주세요!
          </h2>
