...
export const QRCodeSection = (): JSX.Element => {
  return (
        ...
        <CardContent className="flex flex-col items-center gap-2.5 pt-0 pb-5 px-5">
          ...
          <div className="flex flex-col items-center w-full">
            ...
            <div className="flex flex-col items-center w-full mt-[-9px]">
              <div className="relative w-7 h-7 z-[1] bg-white rounded-[14px] border border-solid border-[#dfe3ec] flex items-center justify-center">
                <PlusIcon className="w-4 h-4 text-[#0b0c0e]" />
              </div>
