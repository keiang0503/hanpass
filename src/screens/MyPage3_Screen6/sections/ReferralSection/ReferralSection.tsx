...
export const ReferralSection = (): JSX.Element => {
  return (
        ...
        <CardContent className="flex flex-col items-center gap-2.5 pt-0 pb-5 px-5">
          <div className="relative w-[214px] h-[150px]">
            <img
              ...
              alt="Referral benefits illustration"
              src="https://c.animaapp.com/pWVLYNoL/img/---------1-1-1@2x.png"
            />
          </div>
                ...
                {benefitItems.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-end justify-center gap-[2px_2px] w-full">
                      <span className="w-fit mt-[-1.00px] text-[#0d56e4] text-[length:var(--title-20-b-font-size)] tracking-[var(--title-20-b-letter-spacing)] leading-[var(--title-20-b-line-height)] whitespace-nowrap font-title-20-b font-[number:var(--title-20-b-font-weight)] text-center [font-style:var(--title-20-b-font-style)]">
                        {item.amount}
                      </span>

                      <div className="inline-flex items-center justify-center gap-2.5 px-0 py-[2.5px]">
                        <span className="w-fit text-[length:var(--caption-title-13-b-font-size)] tracking-[var(--caption-title-13-b-letter-spacing)] leading-[var(--caption-title-13-b-line-height)] whitespace-nowrap mt-[-1.00px] font-caption-title-13-b font-[number:var(--caption-title-13-b-font-weight)] text-[#0d56e4] text-center [font-style:var(--caption-title-13-b-font-style)]">
                          {item.currency}
                        </span>
                      </div>
                    </div>
