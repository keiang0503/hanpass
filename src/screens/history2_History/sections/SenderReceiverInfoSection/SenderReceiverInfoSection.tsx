...
export const SenderReceiverInfoSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-6 pt-9 pb-0 px-6 w-full">
      ...
      <Button
        variant="outline"
        className="inline-flex min-h-[46px] items-center justify-center gap-2.5 pl-[26px] pr-5 py-1 bg-white rounded-[30px] border border-solid border-[#5855d6] h-auto hover:bg-white"
      >
        <div className="inline-flex items-center justify-center gap-2">
          <div className="inline-flex items-center gap-1">
            <span className="flex items-center justify-center font-title-15-SB font-[number:var(--title-15-SB-font-weight)] text-[#5855d6] text-[length:var(--title-15-SB-font-size)] text-center tracking-[var(--title-15-SB-letter-spacing)] leading-[var(--title-15-SB-line-height)] w-fit mt-[-1.00px] whitespace-nowrap [font-style:var(--title-15-SB-font-style)]">
              입금 완료
            </span>
            <img
              className="w-4 h-4"
              alt="Btn arrow"
              src="https://c.animaapp.com/yNx7OGE7/img/ico16-btn-arrow-right.svg"
            />
          </div>
        </div>
      </Button>
