...
export const OverviewSection = (): JSX.Element => {
  const transactionData = {
    dateTime: "2024.08.27 17:18:58 KST",
    type: "계좌 이체",
    name: "FTKK VDCC",
    amount: "5 USD",
    exchangeRate: "12,500 (1KRW = 0.00070369 USD)",
    transferNumber: "218159612",
  };

  return (
    <section className="flex flex-col items-center gap-6 pt-9 pb-0 px-6 w-full">
      <Card className="bg-[#979797] border-0 rounded-xl overflow-hidden w-full">
        <CardContent className="flex flex-col items-start gap-4 p-5">
          <div className="flex flex-col items-start gap-0.5 w-full">
            <div className="flex items-center gap-0.5 w-full">
              ...
              <Badge className="bg-[#ffffff4c] hover:bg-[#ffffff4c] text-white font-navigation-12-b font-[number:var(--navigation-12-b-font-weight)] text-[length:var(--navigation-12-b-font-size)] tracking-[var(--navigation-12-b-letter-spacing)] leading-[var(--navigation-12-b-line-height)] [font-style:var(--navigation-12-b-font-style)] px-2.5 py-1 rounded-[50px] h-auto">
            ...
            <div className="flex items-center justify-center w-fit font-title-24-b font-[number:var(--title-24-b-font-weight)] text-white text-[length:var(--title-24-b-font-size)] text-right tracking-[var(--title-24-b-letter-spacing)] leading-[var(--title-24-b-line-height)] whitespace-nowrap [font-style:var(--title-24-b-font-style)]">
