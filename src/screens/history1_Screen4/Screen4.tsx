    ...
    >
      <header className="flex flex-col w-full items-start absolute top-0 left-0 z-10">
        <Link
          ...
          to="/historyu95002-u4370u4450u4363u4460u4361u4457u4540u4352u4467u4535-u4364u4469u4523u4370u4450u4540-u4361u4449u4540u4370u4458u4540u95u4361u4457u4540u4352u4467u4535u4366u4465u4361u4457"
        >
            ...
            <div className="flex h-6 items-center justify-between px-2.5 py-1 relative self-stretch w-full bg-white">
              ...
              <div className="inline-flex items-center gap-1.5 relative flex-[0_0_auto] mt-[-0.50px] mb-[-0.50px]">
                <div className="relative w-[18px] h-2.5">
                  <img
                    className="h-[40.00%] top-[-39550.00%] left-[-11877.78%] absolute w-[16.67%]"
                    alt="Bar"
                    src="/img/bar-1-8.png"
                  />
                  <img
                    className="h-[60.00%] top-[-39570.00%] left-[-11850.00%] absolute w-[16.67%]"
                    alt="Bar"
                    src="/img/bar-2-9.png"
                  />
                  <img
                    className="h-[80.00%] top-[-39590.00%] left-[-11822.22%] absolute w-[16.67%]"
                    alt="Bar"
                    src="/img/bar-3-9.png"
                  />
                  <img
                    className="h-full top-[-39610.00%] left-[-11794.44%] absolute w-[16.67%]"
                    alt="Bar"
                    src="/img/bar-4-5.png"
                  />
                </div>
                <div className="relative w-4 h-[11.62px] overflow-hidden">
                  <img
                    className="absolute w-[31.30%] h-[30.17%] top-[-34013.91%] left-[-13478.18%]"
                    alt="Bar"
                    src="/img/bar-1-9.png"
                  />
                  <img
                    className="absolute w-[62.57%] h-[34.44%] top-[-34050.01%] left-[-13493.75%]"
                    alt="Bar"
                    src="/img/bar-2-10.png"
                  />
                  <img
                    className="absolute w-[100.01%] h-[43.03%] top-[-34083.73%] left-[-13512.52%]"
                    alt="Bar"
                ...
                <div className="relative w-6 h-3 overflow-hidden">
                  <img
                    className="absolute w-[87.51%] h-full top-[-33000%] left-[-9275.00%]"
                    alt="Border"
                    src="/img/border-5.png"
                  />
                  <div className="absolute w-[70.83%] h-[66.67%] top-[16.67%] left-[8.33%] bg-black rounded-[1px]" />
                  <img
                    className="absolute w-[8.33%] h-[33.33%] top-[-32966.67%] left-[-9183.33%]"
                    alt="Cap"
                    src="/img/cap-5.png"
                  />
                </div>
