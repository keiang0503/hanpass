    ...
    <section className="flex flex-col items-center gap-6 pt-9 pb-0 px-6 w-full">
      ...
      >
        ...
        <div className="inline-flex items-center gap-0.5">
          <span className="font-body-15-r font-[number:var(--body-15-r-font-weight)] text-[#717682] text-[length:var(--body-15-r-font-size)] text-center tracking-[var(--body-15-r-letter-spacing)] leading-[var(--body-15-r-line-height)] underline whitespace-nowrap mt-[-1.00px] [font-style:var(--body-15-r-font-style)]">
            [머니그램] 픽업장소를 확인해주세요.
          </span>
      ...
      <Button
        variant="outline"
        className="inline-flex min-h-[46px] justify-center items-center gap-2 pl-[26px] pr-5 py-1 h-auto bg-white rounded-[30px] border border-solid border-[#0579ff] hover:bg-white"
      >
        <span className="font-title-15-SB font-[number:var(--title-15-SB-font-weight)] text-[#0579ff] text-[length:var(--title-15-SB-font-size)] text-center tracking-[var(--title-15-SB-letter-spacing)] leading-[var(--title-15-SB-line-height)] whitespace-nowrap mt-[-1.00px] [font-style:var(--title-15-SB-font-style)]">
          입금 완료
        </span>

        <ChevronRightIcon className="w-4 h-4 text-[#0579ff]" />
      </Button>
    </section>
  );
};
