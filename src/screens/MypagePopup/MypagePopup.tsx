...
export const MypagePopup = (): JSX.Element => {
  return (
    <div
      className="flex flex-col w-full h-screen items-center justify-center bg-overlay-dark"
      data-model-id="36848:90439"
    >
      <PopupHeader />
      <Card className="flex flex-col max-w-[432px] mx-6 bg-white rounded-[22px] shadow-[0px_10px_14px_#5a5a5a29] border-0">
